...
public class ThreadManager {
    ...
    private final Queue<PhotoTask> mTaskWorkQueue;

    // A managed pool of background download threads
    private final LoaderExecutorService mDownloadThreadPool;

    // A managed pool of background decoder threads
    private final LoaderExecutorService mDecodeThreadPool;
    ...
    private ThreadManager() {
         ...
         */
        mTaskWorkQueue = new LinkedBlockingQueue<PhotoTask>();

        /*
         * Creates a new pool of Thread objects for the download work queue
         */
        mDownloadThreadPool =new LoaderExecutorService();
                //new LoaderExecutorService(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE,
                //KEEP_ALIVE_TIME, KEEP_ALIVE_TIME_UNIT, mDownloadWorkQueue, Utils.LoaderThreadFactory);

        /*
         * Creates a new pool of Thread objects for the decoding work queue
         */
        mDecodeThreadPool =new LoaderExecutorService();
                //new LoaderExecutorService(NUMBER_OF_CORES, NUMBER_OF_CORES,
    ...
    static public PhotoTask startDownload(
         ...
         */
        PhotoTask downloadTask = sInstance.mTaskWorkQueue.poll();
        ...
        downloadTask.initializeDownloaderTask(ThreadManager.sInstance, imageView, cacheFlag);
