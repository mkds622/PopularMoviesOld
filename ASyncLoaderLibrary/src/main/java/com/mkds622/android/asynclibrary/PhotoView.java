...
//        attributes.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if ((!mIsDrawn) && (mImageURL != null)) {
            ...
            mDownloadThread = ThreadManager.startDownload(this, mCacheFlag);
    ...
    public void setImageURL(URL pictureURL, boolean cacheFlag, Drawable imageDrawable) {
        ...
        if (mImageURL != null) {
            ...
            if (!mImageURL.equals(pictureURL)) {
                ...
                ThreadManager.removeDownload(mDownloadThread, mImageURL);
            } else {
        ...
        if ((mIsDrawn) && (pictureURL != null)) {
             ...
             */
            mDownloadThread = ThreadManager.startDownload(this, cacheFlag);
        }
    }
