...
import com.mkds622.android.asynclibrary.PhotoDecodeRunnable.TaskRunnableDecodeMethods;
 ...
 */
class PhotoDownloadRunnable implements Runnable,Comparable {
        ...
        try {
            ...
            if (null == byteBuffer) {
                ...
                try {
                    ...
                    //httpConn.setRequestProperty("User-Agent", SyncStateContract.Constants.USER_AGENT);
